...
export default function Landing() {
  ...
  return (
    <>
      <SEO
        title="JobBoardX | Your Next Job Awaits"
        description="Welcome to JobBoardX – the job board that connects you to thousands of career opportunities. Sign up to apply and track your applications."
        url={`${DOMAIN}/`}
      />
